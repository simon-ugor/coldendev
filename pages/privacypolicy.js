      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          <div>
            ...
            <p>Simon Ugor built apps WhatTheRocket, Drop That Box, Planets Dodge and Hack The Game as Free apps. This SERVICE is provided by Simon Ugor at no cost and is intended for use as is.
